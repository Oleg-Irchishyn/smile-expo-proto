...
var q1 = 0.8010174203645368;
var q2 = 0.28913644137413;
var q3 = 0.05168994475970925;

var colorArr = [q1 + 0.2, q2 + 0.2, q3 + 0.2 ];

canvas.addEventListener( 'mousemove', function ( e ) {

    count++;

    ( count > 25 ) && (colorArr = [q1 + 0.2, q2 + 0.2, q3 + 0.2 ], count = 0);
